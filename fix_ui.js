...
const fixPlaylists = () => {
    let content = fs.readFileSync('cms-dashboard/src/app/playlists/page.tsx', 'utf8');
    ...
    fs.writeFileSync('cms-dashboard/src/app/playlists/page.tsx', content);
};

const fixAssets = () => {
    let content = fs.readFileSync('cms-dashboard/src/app/assets/page.tsx', 'utf8');
    ...
    fs.writeFileSync('cms-dashboard/src/app/assets/page.tsx', content);
};
